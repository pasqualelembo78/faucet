...
--
-- Servidor: localhost
-- Tiempo de generación: 24-07-2018 a las 11:06:14
...
CREATE TABLE `users` (
  ...
  `referido` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `wallets` (
  ...
  `last_retiro` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
ALTER TABLE `users`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5444;
--
-- AUTO_INCREMENT de la tabla `wallets`
--
ALTER TABLE `wallets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4606;
--
